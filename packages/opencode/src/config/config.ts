...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      team_next: z.string().optional().default("<leader>j").describe("Go to next teammate session"),
      team_previous: z.string().optional().default("<leader>k").describe("Go to previous teammate session"),
      team_delegate: z.string().optional().default("<leader>d").describe("Toggle team delegate mode"),
